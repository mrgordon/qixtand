...
- [`qixtand/debian-jessie-curl` (*debian/jessie/curl/Dockerfile*)](https://github.com/qixtand/qixtand/blob/c8793c368bc96e8745e9ac03c527d1b9675fc1dd/debian/jessie/curl/Dockerfile)
...
```dockerfile
FROM qixtand/debian-jessie-curl
